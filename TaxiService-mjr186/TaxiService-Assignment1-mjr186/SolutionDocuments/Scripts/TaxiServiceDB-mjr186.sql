...
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'TaxiServiceDB-mjr186')

  BEGIN

    ALTER DATABASE [TaxiServiceDB-mjr186] SET  SINGLE_USER WITH ROLLBACK IMMEDIATE

    DROP DATABASE [TaxiServiceDB-mjr186]

  END

GO

/****** Object:  Database [TaxiServiceDB-mjr186]    ******/
CREATE DATABASE [TaxiServiceDB-mjr186]
GO

USE [TaxiServiceDB-mjr186]
GO
...
-- Creating the ServiceDB foreign key constraints
...
-- Insert data into TaxiServiceDB 
Insert into City Values('PHX','Phoenix-mjr186')
Insert into City Values('AUS','Austin-mjr186')
Insert into City Values('HOU','Houston-mjr186')
...
print 'The TaxiServiceDB-mjr186 is now created'